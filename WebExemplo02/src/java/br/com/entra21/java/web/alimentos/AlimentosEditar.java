...
public class AlimentosEditar extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("</div>");
        out.println("<div>");
        out.println("<label for='campo-preco'>Preco</label>");
        ...
        out.println("<textarea name='' id='campo-descricao' name='descricao' value'" + alimento.getDescricao() +"'></textarea>");
        out.println("</div>");
        out.println("<input type='sibmit' value='Alterar'>");
        out.println("</form>");
        out.println("</body>");
        out.println("</html>");
